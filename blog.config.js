...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'ByIris', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Devota de la diversidad artrópoda, amante del código y el arcano arte matemático 🕷️✨', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://byiriss.com/article/python-problems-l', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, Math, Python', // 网站关键词 英文逗号隔开
